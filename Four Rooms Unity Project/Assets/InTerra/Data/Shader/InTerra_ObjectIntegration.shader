Shader "InTerra/Object into Terrain Integration"
{
    Properties
    {
        ...
        [HideInInspector] _HeightmapScale("hms", Vector) = (0,0,0) 
    ...
    SubShader {
        ...
        #pragma shader_feature_local _OBJECT_STEEP_INTERSECTION

        #pragma shader_feature_local ONE_PASS ONE_LAYER TWO_LAYERS
