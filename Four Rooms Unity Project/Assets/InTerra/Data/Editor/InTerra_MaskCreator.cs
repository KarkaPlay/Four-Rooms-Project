...
namespace InTerra
{
    public class InTerra_MaskCreator : EditorWindow
    {
        ...
        public static void OpenWindow(bool normalMask)
        {
            ...
            Vector2 size = normalMask ? new Vector2(320, 280) : new Vector2(420, 260);
        ...
        void NormalInMask()
        {
            ...
            info = EditorGUILayout.Foldout(info, "Normal-Mask map Texture info");
            if (info)
            {
        ...
        void Mask()
        {
            Vector2 size = new Vector2(420, 260);
        ...
        void SaveMaskTexture(int format, Texture2D texture, string path)
        {
            ...
            {
                Debug.LogWarning("Saving File " +  path + " filed.");
            }
        }
